...
export const comunidadSchema= z.object({
    ...
    name: z.string().min(1, "Nombre requerido").max(50, "Has exedido el numero de caracteres permitidos en el nombre de la comunidad.").regex(/[a-zA-Z]/, "El nombre es invalido"),
